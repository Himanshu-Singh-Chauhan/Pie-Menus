...
from PySide2.QtCore import Qt, QRectF, QSize, QTimer, Signal
from PySide2.QtGui import QPixmap, QImage, QPainter, QPainterPath,QColor
from PySide2.QtWidgets import QWidget, QLabel, QHBoxLayout,QGridLayout, QSpacerItem, QSizePolicy, QGraphicsDropShadowEffect,\
...
if __name__ == '__main__':
    ...
    layout.addWidget(QPushButton(
        'Error', w, clicked=lambda: NotificationWindow.error(
            'Test notification',
            '<html><head/><body><p><span style=" font-style:italic; color:teal;">this is test notification</span></p></body></html>',
            callback=callback)))
    w.show()
